...
// Initialize entities
        ...
        Student studentSix = new Student("Rosica", "Nenova", "C#");
        Student studentSeven = new Student("Rosica", "Nenova", "C#");
        Student studentEight = new Student("Rosica", "Nenova", "C#");
...
// Register Student
        ...
        System.out.println(softUni.insert(studentFour));
        System.out.println(softUni.insert(studentFive));
        System.out.println(softUni.insert(studentSix));
        System.out.println(softUni.insert(studentEight));
        System.out.println(softUni.insert(studentEight));
        System.out.println(softUni.insert(studentSeven));
